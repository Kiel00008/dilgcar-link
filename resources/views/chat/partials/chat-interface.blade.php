...
<style>
    ...
    .ref-accordion {
        --ref-row-bg: rgba(255, 255, 255, 0.96);
        margin-top: 1px;
        padding: 6px 10px;
    ...
    .ref-accordion:not(.is-open) .ref-accordion-body::after {
        content: '';
        position: absolute;
        top: 0;
        right: 0;
        height: 100%;
        width: 60%;
        background: linear-gradient(to right, rgba(255, 255, 255, 0), var(--ref-row-bg) 70%);
        pointer-events: none;
    }
